...
class JustificationCard extends GenericCard {
  ...
  JustificationCard(Justification this.justification) {
    switch (justification.state) {
      case 'Accepted':
        status_text = "Aceite";
      ...
      children: [
        Container(
            margin: const EdgeInsets.only(
                top: 10.0, bottom: 30.0, left: 15.0, right: 15.0),
            child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                children: <Widget>[
                  ...
                  Text(this.justification.course,
            ...
            child: Row(
                ...
                children: <Widget>[
                  Text("Cadeira:",
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(color: secondary_text_color)),
                  Text(this.justification.class_,
